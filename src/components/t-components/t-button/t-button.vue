<template>
    <button
        class="cp-t-button text-center leading-tight"
        :class="{
    ...
    >
        ...
        <slot v-else name="loading">
            <view class="flex items-center">
                <u-loading-icon mode="semicircle" :color="plain ? color : textColor" :size="loadingSize"></u-loading-icon>
...
export default {
    props: {
        ...
        openType: {
            type: String,
            validator: (val) =>
                ["", "feedback", "share", "getUserInfo", "contact", "getPhoneNumber", "launchApp", "openSetting"].includes(val),
            default: "",
        },
        // 激活状态class name
        hoverClass: {
    ...
    computed: {
        style() {
            ...
            return {backgroundColor, color, border, display};
        },
        loadingSize() {
